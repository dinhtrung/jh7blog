...
public class CategoryResource {
    ...
    public ResponseEntity<CategoryDTO> getCategory(@PathVariable Long id) {
        ...
        Optional<CategoryDTO> categoryDTO = categoryRepository.findById(id).map(categoryMapper::toDto);
    ...
    public ResponseEntity<List<CategoryDTO>> searchCategories(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(categoryMapper.toDto(page.getContent()));
    }
}
