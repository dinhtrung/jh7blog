...
```
$ docker image tag blog registry.container-registry/blog
$ docker push registry.container-registry/blog
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n app
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n app
```
...
```
$ kubectl get svc jhipster-prometheus -n app
```
...
```
$ kubectl get svc jhipster-grafana -n app
```
